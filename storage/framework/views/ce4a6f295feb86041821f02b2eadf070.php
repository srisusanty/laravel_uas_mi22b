            ...
            <div class="row">
                <div class="col-12 p-b-20">
                    ...
                    <div class="row gallery-container grid">
                        <?php $__currentLoopData = $products_images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-6 col-sm-4 col-md-3 col-lg-2 p-2 product-item">
                                <div class="of-hidden pos-relative">
                                    <img class="max-w-full m-b-7" src="<?php echo e(url($product->image)); ?>" alt="IMG-PRODUCT">
                                </div>
                                <p class="fw-bold text-center"><?php echo e($product->title); ?></p>
                            </div>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\toko-online\resources\views/front/gallery.blade.php ENDPATH**/ ?>