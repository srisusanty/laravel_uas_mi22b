...
<body style="background: #edf2f7">
    ...
    <header id="header" class="header fixed-top d-flex align-items-center bg-dark">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="<?php echo e(route('front.index')); ?>" class="logo d-flex align-items-centern text-light">
                Customer
            </a>
    ...
    <aside id="sidebar" class="sidebar bg-dark">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <a class="nav-link <?php echo e(request()->routeIs('customer.index') ? 'active' : 'collapsed'); ?>"
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo e(request()->routeIs('myorder') ? 'active' : 'collapsed'); ?>"
                    href="<?php echo e(route('myorder')); ?>">
                    <i class="bi bi-cart"></i>
                    My Order</a>
            </li>
            <li class="nav-item">
                <a class="nav-link <?php echo e(request()->routeIs('mypayment') ? 'active' : 'collapsed'); ?>"
                    href="<?php echo e(route('mypayment')); ?>">
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo e(request()->routeIs('myreview') ? 'active' : 'collapsed'); ?>"
                    href="<?php echo e(route('myreview')); ?>">
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo e(request()->routeIs('profile-customer') ? 'active' : 'collapsed'); ?>"
                    href="<?php echo e(route('profile-customer')); ?>">
...
<?php /**PATH C:\xampp\htdocs\toko-online\resources\views/layouts/cust.blade.php ENDPATH**/ ?>